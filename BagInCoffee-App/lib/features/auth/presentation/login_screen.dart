...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      // 로그인 후 프로필 및 데이터 새로고침
      await getAuthManager(ref).onLoginSuccess();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildFeatureItem(
                            ...
                            title: '추출 기록',
                            description: '나만의 레시피를 기록하고 관리하세요',
                          ),
                          const SizedBox(height: 20),
                          _buildFeatureItem(
                            icon: LucideIcons.barChart2,
                            title: '통계 분석',
                            description: '추출 데이터를 분석하고 개선하세요',
                          ),
                          const SizedBox(height: 20),
                          _buildFeatureItem(
                            icon: LucideIcons.users,
                            title: '커뮤니티',
                            description: '다른 커피 애호가들과 소통하세요',
                          ),
                        ],
                      ),
                    ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: isDesktop ? 40 : AppSpacing.xxxl),
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: isDesktop ? '비밀번호를 입력하세요' : null,
              prefixIcon: isDesktop
          ...
          SizedBox(height: isDesktop ? 24 : AppSpacing.xxxl),
